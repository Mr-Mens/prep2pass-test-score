...
export const PUBLIC_FAQ: PublicFaqItem[] = [
  {
    ...
    a: "Learners pay £6.99/month until they pass or cancel. Instructor and parent accounts are free.",
  },
  {
  ...
  {
    q: "Can parents and supervisors use Pass Pilot?",
  ...
  },
  {
    ...
    a: "Record your pass in Graduate Mode and Pass Pilot automatically stops future billing. Your account and reports stay available.",
  },
  {
