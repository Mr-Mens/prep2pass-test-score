...
export function MarketingStickyCta({ hidden = false }: Props) {
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-50 border-t border-brand-200/80 bg-white/95 px-4 pb-safe-fixed pt-3 shadow-[0_-8px_32px_rgba(15,40,54,0.08)] backdrop-blur-md supports-[backdrop-filter]:bg-white/90 md:hidden"
    >
      <Link
        href="/assessment"
