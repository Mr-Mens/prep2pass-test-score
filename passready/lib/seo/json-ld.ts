...
export function productOfferJsonLd(): JsonLd {
  return {
    ...
    description:
      "Monthly learner platform access: unlimited Test Ready Score assessments, Personalised Smart Reports, Smart Insights and Learning Journey tracking until you pass or cancel.",
    brand: {
      "@type": "Brand",
      name: PRODUCT.name,
    },
