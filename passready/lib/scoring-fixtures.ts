...
export const SCORING_BENCHMARK_FIXTURES: ScoringBenchmarkFixture[] = [
  ...
  },
  {
    ...
    expectedScoreMin: 60,
    expectedScoreMax: 70,
    rationale: "Lesson gap and no-mock path reduce score; limited weak areas avoid max cap but confidence is below neutral.",
  },
  {
  ...
  },
  {
    ...
    expectedScoreMin: 80,
    expectedScoreMax: 86,
    rationale: "Low confidence drags from baseline but pass mock, few faults, and a single low-tier weak area keep the headline score in Test Ready.",
  },
  {
