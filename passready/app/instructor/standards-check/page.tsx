...
export default function InstructorStandardsCheckHubPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-6 pb-4">
      <Link href="/instructor/adi-hub" className="text-sm font-semibold text-teal-800 underline-offset-4 hover:underline">
        ← ADI Hub
      </Link>
      <header className="rounded-3xl border border-brand-100 bg-gradient-to-br from-white via-brand-50/80 to-teal-50/40 p-8 shadow-sm">
        <p className="text-[11px] font-bold uppercase tracking-[0.12em] text-teal-800">Standards Check Hub</p>
      ...
      <section className="rounded-2xl border border-dashed border-brand-200 bg-brand-50/40 px-6 py-10 text-center">
        ...
        <p className="mt-2 text-sm text-brand-600">
          We&apos;re building this hub alongside Lesson Reviews so your professional development stays connected.
        </p>
        <Link
