export const MOCK_REFLECTION_CATEGORIES = [
  ...
  { id: "manoeuvres", label: "Manoeuvres (parking)" },
...
export const MOCK_REFLECTION_SUB_OPTIONS = [
  ...
  { id: "junctions_approach_too_fast", categoryId: "junctions", label: "Approached too fast" },
  { id: "junctions_approach_too_slow_hesitant", categoryId: "junctions", label: "Approached too slow / hesitant" },
  ...
  { id: "manoeuvres_lost_control", categoryId: "manoeuvres", label: "Lost control" },
  { id: "manoeuvres_poor_observation", categoryId: "manoeuvres", label: "Poor observation" },
  { id: "manoeuvres_positioning", categoryId: "manoeuvres", label: "Poor final position" },
